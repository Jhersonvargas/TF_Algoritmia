...
Puede ingresar solo los codigos de productos y el sistema te arrojará los precios""");
...
#condicion para la segunda columna de codigo de producto, precio y unidad
    ...
    #condicion para la tercera celda de codigo de producto, precio y unidad
    ...
    #fijando los valores mediane el metodo set a precio, descripcion, codigo y unidad
        ...
        obtenerUnidad2.set(str(uni2));
            ...
            MessageBox.showinfo("AVISO IMPORTANTE","""En la columna Cod_Prod ingresar un numero válido.
...
root.iconbitmap('pila.ico')# imagen con el icono de mi ventana
...
#label titulo
lDni = Label(miFrame, text='Ferretria El tornillo Feliz', font=("calibri", 18),bg= "#A4D8D4" )
